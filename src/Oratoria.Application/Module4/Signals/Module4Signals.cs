...
{
    public class Module4Signals : IModuleSignals
    {
        private readonly ModbusTCPConfig _netConfig;
        public Module4DI DISignals { get; }
        public Module4DO DOSignals { get; }
        public Module4AI AISignals { get; }
        public Module4AO AOSignals { get; }
...
#if RELEASE
        public Module4Signals(NetContext netContext)
        {
            _netConfig = netContext.Module4;
...
#else
        public Module4Signals(NetContext netContext, IRegister model)
        {
            var twinStrategy = new DigitalTwinStrategy(model.GetModule(nameof(Module4Signals)));
            _netConfig = netContext.Module4;
