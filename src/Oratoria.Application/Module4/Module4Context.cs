...
namespace Oratoria.Application.Module4
{
    public class Module4Context : TechnologyModuleContext
    {
        public Module4Context(Module4Signals signals, ILoggerFactory loggerFactory, ISettingsContext settings) : base(signals, loggerFactory, settings)
        {
        ...
        public override string Name => ModuleId.Module4.GetDescription();
    }
}
