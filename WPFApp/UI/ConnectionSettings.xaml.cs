...
namespace Oratoria36.UI
{
    ...
    public class ConnectionSettingsVM : INotifyPropertyChanged
    {
        ...
        public ConnectionSettingsVM()
        {
            ...
            ConnectCommandModule1 = new RelayCommand(ConnectModule1, (object obj) => { return !Module1.IsConnected; }) ;
            DisconnectCommandModule1 = new RelayCommand(DisconnectModule1, (object obj) => { return Module1.IsConnected; });
            ApplySettingsCommandModule1 = new RelayCommand(ApplySettingsModule1);

            ConnectCommandModule2 = new RelayCommand(ConnectModule2, (object obj) => { return !Module2.IsConnected; });
            DisconnectCommandModule2 = new RelayCommand(DisconnectModule2, (object obj) => { return Module2.IsConnected; });
        ...
        {
            _logger.Info($"Подключение к {Module1.IP}:{Module1.Port}");
        ...
        private async void ApplySettingsModule1(object parameter)
        {
            ...
            try
            {
                ...
                _logger.Info($"Сетевые настройки успешно применены: {ipToApply}:{portToApply}");
            }
            catch (Exception ex)
            {
        ...
        {
            _logger.Info($"Подключение к {Module2.IP}:{Module2.Port}");
